...
public class AcsIssueTocCrawlTask extends BasicIssueTocCrawlerTask {
    ...
    @Inject
    public AcsIssueTocCrawlTask(final Fetcher<UriRequest, CrawlerResponse> fetcher, final AcsIssueTocParserFactory parserFactory, final ArticleArchiver articleArchiver, final IssueArchiver issueArchiver, final IssueHandler issueHandler) {
