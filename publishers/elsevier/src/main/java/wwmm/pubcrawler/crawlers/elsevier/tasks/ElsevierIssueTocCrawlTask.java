...
public class ElsevierIssueTocCrawlTask implements TaskSpecification<IssueTocCrawlTaskData> {
    ...
    public static class Runner extends BasicIssueTocCrawlerTaskRunner {
        ...
        @Inject
        public Runner(final Fetcher<UriRequest, CrawlerResponse> fetcher, final ElsevierIssueTocParserFactory parserFactory, final ArticleArchiver articleArchiver, final IssueArchiver issueArchiver, final IssueHandler issueHandler) {
