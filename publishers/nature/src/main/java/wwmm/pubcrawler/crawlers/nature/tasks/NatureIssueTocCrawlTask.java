...
import wwmm.pubcrawler.crawlers.nature.NatureIssueTocParserFactory;
...
public class NatureIssueTocCrawlTask implements TaskSpecification<IssueTocCrawlTaskData> {
    ...
    public static class Runner extends BasicIssueTocCrawlerTaskRunner {
        ...
        @Inject
        public Runner(final Fetcher<UriRequest, CrawlerResponse> fetcher, final NatureIssueTocParserFactory parserFactory, final ArticleArchiver articleArchiver, final IssueArchiver issueArchiver, final IssueHandler issueHandler) {
