...
public class WileyPublicationListCrawlTask extends BasicPublicationListCrawlTask {
    ...
    @Inject
    public WileyPublicationListCrawlTask(final Fetcher<UriRequest, CrawlerResponse> fetcher, final WileyPublicationListParserFactory parserFactory, final JournalArchiver journalArchiver, final JournalHandler journalHandler) {
