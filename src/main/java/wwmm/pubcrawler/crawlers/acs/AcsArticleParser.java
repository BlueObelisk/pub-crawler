 ...
 * @version 2
 */
public class AcsArticleParser extends AbstractArticleParser {

    private static final Logger LOG = Logger.getLogger(AcsArticleParser.class);

    public AcsArticleParser(final Article articleRef, final Document document, final URI uri) {
	 ...
	 */
    protected URI getSupportingInfoUrl() {
    ...
    protected List<FullTextResource> getFullTextResources() {
