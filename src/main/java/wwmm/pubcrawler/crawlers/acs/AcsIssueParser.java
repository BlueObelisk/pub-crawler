 ...
 * @version 2.0
 */
public class AcsIssueParser extends AbstractIssueParser {

    private static final Logger LOG = Logger.getLogger(AcsIssueParser.class);

    private String journalTitle;
    private String volume;
    private String number;

    public AcsIssueParser(final Issue issueRef, final Document html, final Journal journal) {
